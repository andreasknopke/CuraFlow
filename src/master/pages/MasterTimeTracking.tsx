...
export default function MasterTimeTracking() {
  ...
  const { data: timeData, isLoading } = useQuery<TimeData>({
  ...
  const summary: TimeSummary | null = timeData?.summary ?? null;
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12 text-slate-400">
              ...
              <p className="text-sm mt-1">
                Die Master-API muss noch mit den Mandanten-Datenbanken verbunden werden.
              </p>
            </div>
          ) : (
                  ...
                  {entries.map((entry, i) => {
                    ...
                    return (
                      <TableRow key={i}>
                        ...
                        <TableCell
                          className={`text-right font-semibold ${deltaNum >= 0 ? 'text-emerald-600' : 'text-red-600'}`}
                        >
                          {deltaNum > 0 ? '+' : ''}
                          {delta}
                        </TableCell>
