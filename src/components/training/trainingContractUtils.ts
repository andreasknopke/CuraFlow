...
export function isDateWithinContract(date: Date | null | undefined, contractStart?: string, contractEnd?: string): boolean {
...
export function clampRangeToContract(
...
export function getTrainingContractInfo(contractStart?: string, contractEnd?: string, referenceDate: Date = new Date()): ContractInfo | null {
...
export function getContractTooltipLabel(contractInfo: ContractInfo | null): string | null {
