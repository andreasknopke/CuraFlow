...
export const DEFAULT_TEAM_ROLES: TeamRoleData[] = [
    ...
    // "Azubi …" roles intentionally NOT seeded as defaults: their names conflict
    // with trainee positions imported from the central employee management
    // (e.g. seed "Azubi MTR" vs. imported "MTR-Azubi"), which produced hard-to-
    // delete duplicate roles across tenants. Trainees should be created on
    // demand per tenant instead.
