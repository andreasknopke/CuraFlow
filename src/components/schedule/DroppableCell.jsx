    ...
    <Droppable droppableId={id} isDropDisabled={isDisabled || isReadOnly} direction="horizontal">
      {(provided, snapshot) => (
        <div
          ...
          className={`
          min-h-[60px] p-1 border transition-colors duration-75 rounded-sm h-full flex flex-wrap content-start gap-1 relative
          ...
          ${!isDisabled && snapshot.isDraggingOver ? 'border-indigo-300 ring-2 ring-indigo-300 z-10' : (
