...
export default function OverrideConfirmDialog({
  ...
  const _hasBlockers = blockers.length > 0;
  const _hasWarnings = warnings.length > 0;
        ...
        {step === 1 ? (
          ...
          <>
            ...
            <DialogFooter className="gap-2 sm:gap-2">
              ...
              <Button onClick={handleOverrideClick} className="bg-amber-600 hover:bg-amber-700">
                Fortfahren
              </Button>
            </DialogFooter>
          </>
          ...
          <>
            ...
            <DialogFooter className="gap-2 sm:gap-2">
              <Button variant="outline" onClick={handleBackToWarning} disabled={isSubmitting}>
                Zurück
              </Button>
              <Button
