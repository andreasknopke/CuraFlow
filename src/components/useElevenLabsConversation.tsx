...
interface ElevenLabsMessage {
  type: string;
  audio_event?: { audio_base_64?: string; audio_base64_chunk?: string };
...
interface UseElevenLabsConversationOptions {
  agentId: string;
  onMessage?: (msg: ElevenLabsMessage) => void;
...
export function useElevenLabsConversation({
  ...
  const decodeAndQueueAudio = useCallback(
        ...
        ws.onmessage = (event) => {
          try {
            ...
            if (msg.type === 'audio') {
              ...
              const audioData =
                msg.audio_event?.audio_base_64 || msg.audio_event?.audio_base64_chunk;
