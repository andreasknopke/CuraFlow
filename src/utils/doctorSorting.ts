...
export const isAlphabeticalDoctorSortingEnabled = (user: UserLike | null | undefined): boolean => {
...
export const sortDoctorsAlphabetically = <T extends DoctorLike>(doctorList: T[] = []): T[] => {
