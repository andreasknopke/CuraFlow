    ...
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-slate-600 max-w-2xl mx-auto">
          Das intelligente Dienstplanungs-System für die Radiologie. Effiziente Planung,
          transparente Übersichten und KI-gestützte Optimierung.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-1 gap-8 max-w-xl mx-auto">
        <Card className="border-2 border-indigo-100 hover:border-indigo-300 transition-all cursor-pointer hover:shadow-md group">
          <CardHeader>
            ...
            <CardDescription>
              {isAuthenticated
                ? 'Wochenplan und Verwaltung öffnen'
                : 'Login für Mitarbeiter und Verwaltung'}
            </CardDescription>
          </CardHeader>
          <CardContent>
