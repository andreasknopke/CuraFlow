...
export interface StaffingPlanNote extends Auditable {
  id: string;
  doctor_id: string;
  year: number;
  note: string;
...
export interface TrainingRotation extends Auditable {
  id: string;
  doctor_id: string;
  title?: string | null;
...
export interface CustomHoliday extends Auditable {
  id: string;
  date: string;
  name: string;
