    ...
    try {
      ...
      if (table.name === 'TeamRole') {
        ...
        const defaultRoles = [
          ...
          { id: crypto.randomUUID(), name: 'Azubi MFA', priority: 16, is_specialist: false, can_do_foreground_duty: false, can_do_background_duty: false, excluded_from_statistics: false, description: 'Auszubildende/r Medizinische Fachangestellte' },
          { id: crypto.randomUUID(), name: 'Azubi PFF', priority: 17, is_specialist: false, can_do_foreground_duty: false, can_do_background_duty: false, excluded_from_statistics: false, description: 'Auszubildende/r Pflegefachkraft' },
          { id: crypto.randomUUID(), name: 'Azubi PFM', priority: 18, is_specialist: false, can_do_foreground_duty: false, can_do_background_duty: false, excluded_from_statistics: false, description: 'Auszubildende/r Pflegefachmann/-frau' },
          { id: crypto.randomUUID(), name: 'Azubi PFFP', priority: 19, is_specialist: false, can_do_foreground_duty: false, can_do_background_duty: false, excluded_from_statistics: false, description: 'Auszubildende/r Pflegefachkraft (Praktikum)' },
          { id: crypto.randomUUID(), name: 'Azubi ATA', priority: 20, is_specialist: false, can_do_foreground_duty: false, can_do_background_duty: false, excluded_from_statistics: false, description: 'Auszubildende/r Anästhesietechnische Assistenz' },
          { id: crypto.randomUUID(), name: 'Azubi OTA', priority: 21, is_specialist: false, can_do_foreground_duty: false, can_do_background_duty: false, excluded_from_statistics: false, description: 'Auszubildende/r Operationstechnische Assistenz' },
          { id: crypto.randomUUID(), name: 'Azubi MTR', priority: 22, is_specialist: false, can_do_foreground_duty: false, can_do_background_duty: false, excluded_from_statistics: false, description: 'Auszubildende/r Medizinischer Technologe Radiologie' },
          { id: crypto.randomUUID(), name: 'Azubi MTL', priority: 23, is_specialist: false, can_do_foreground_duty: false, can_do_background_duty: false, excluded_from_statistics: false, description: 'Auszubildende/r Medizinischer Technologe Labor' },
          { id: crypto.randomUUID(), name: 'Azubi KAPH', priority: 24, is_specialist: false, can_do_foreground_duty: false, can_do_background_duty: false, excluded_from_statistics: false, description: 'Auszubildende/r Krankenpflegehilfe' },
