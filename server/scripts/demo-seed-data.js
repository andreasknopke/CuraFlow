...
export function buildDemoSeedData(referenceDate = new Date()) {
  ...
  return {
    ...
    teamRoles: [
      ...
      [demoId('role-nurse'), 'Pflegekraft', 5, false, false, false, false, 'Nursing care staff'],
      [demoId('role-mtr'), 'MTR', 6, false, false, false, false, 'Medical technologist for radiology'],
      [demoId('role-mtl'), 'MTL', 7, false, false, false, false, 'Medical technologist for laboratory analytics'],
      [demoId('role-mta'), 'MTA', 8, false, false, false, false, 'Medical technical assistant'],
      [demoId('role-physician-assistant'), 'Physician Assistant', 9, false, false, false, false, 'Physician assistant'],
      [demoId('role-auxiliary'), 'Hilfskraft', 10, false, false, false, false, 'Auxiliary staff'],
      [demoId('role-student'), 'Student', 11, false, false, false, false, 'Medical student'],
      [demoId('role-intern'), 'Hospitant', 12, false, false, false, false, 'Intern / observer'],
      [demoId('role-mfa'), 'MFA', 13, false, false, false, false, 'Medical assistant'],
      [demoId('role-pflegefachkraft'), 'Pflegefachkraft', 14, false, false, false, false, 'Nursing professional'],
      [demoId('role-kaph'), 'KAPH', 15, false, false, false, false, 'Nursing assistant'],
      [demoId('role-azubi-mfa'), 'Azubi MFA', 16, false, false, false, false, 'Trainee medical assistant'],
      [demoId('role-azubi-pff'), 'Azubi PFF', 17, false, false, false, false, 'Trainee nursing professional'],
      [demoId('role-azubi-pfm'), 'Azubi PFM', 18, false, false, false, false, 'Trainee nursing specialist'],
      [demoId('role-azubi-pffp'), 'Azubi PFFP', 19, false, false, false, false, 'Trainee nursing (internship)'],
      [demoId('role-azubi-ata'), 'Azubi ATA', 20, false, false, false, false, 'Trainee anesthesia assistant'],
      [demoId('role-azubi-ota'), 'Azubi OTA', 21, false, false, false, false, 'Trainee surgical assistant'],
      [demoId('role-azubi-mtr'), 'Azubi MTR', 22, false, false, false, false, 'Trainee radiology technologist'],
      [demoId('role-azubi-mtl'), 'Azubi MTL', 23, false, false, false, false, 'Trainee laboratory technologist'],
      [demoId('role-azubi-kaph'), 'Azubi KAPH', 24, false, false, false, false, 'Trainee nursing assistant'],
      [demoId('role-studentische-hilfskraft'), 'Studentische Hilfskraft', 25, false, false, false, false, 'Student assistant'],
      [demoId('role-pflegerische-hilfskraft'), 'Pflegerische Hilfskraft', 26, false, false, false, false, 'Nursing auxiliary'],
    ],
    doctors: [
