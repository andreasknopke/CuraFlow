...
export function buildDemoSeedData(referenceDate = new Date()) {
  ...
  return {
    ...
    teamRoles: [
      ...
      [demoId('role-nurse'), 'Pflegekraft', 5, false, false, false, true, 'Nursing care staff'],
      [demoId('role-mtr'), 'MTR', 6, false, false, false, true, 'Medical technical radiology assistant'],
      [demoId('role-mtl'), 'MTL', 7, false, false, false, true, 'Medical technical laboratory assistant'],
      [demoId('role-mta'), 'MTA', 8, false, false, false, true, 'Medical technical assistant'],
      [demoId('role-physician-assistant'), 'Physician Assistant', 9, false, false, false, true, 'Physician assistant'],
      [demoId('role-auxiliary'), 'Hilfskraft', 10, false, false, false, true, 'Auxiliary staff'],
      [demoId('role-student'), 'Student', 11, false, false, false, true, 'Medical student'],
      [demoId('role-intern'), 'Hospitant', 12, false, false, false, true, 'Intern / observer'],
    ],
    doctors: [
